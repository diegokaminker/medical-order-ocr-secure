// Vercel serverless function for nomenklator API
import fs from 'fs';
...
export default async function handler(req, res) {
    ...
    try {
        ...
        // Route handling
        if (pathname === '/api/nomenklator/stats') {
            if (method === 'GET') {
        ...
        if (pathname === '/api/nomenklator/search') {
            if (method === 'GET') {
        ...
        if (pathname.startsWith('/api/nomenklator/') && pathname !== '/api/nomenklator/stats' && pathname !== '/api/nomenklator/search') {
        ...
        // Default route - get all entries
        if (pathname === '/api/nomenklator') {
            if (method === 'GET') {
